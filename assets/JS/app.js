...
//Giphy Function--argument is the title of the button
    var searchGiphy= function(search){
        ...
        .then(function(response){
            ...
            //append our gif into the card
            $("#gifSection").prepend(newCard);
            // append our dynamically created card with a gif to our gif section
